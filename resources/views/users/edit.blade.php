                            ...
                            <div class="card-body">
                                <form class="row" action="{{ route('users.update', [$user->id]) }}" method="POST"
                                    ...
                                    <div class="mb-3 col-4">
                                        ...
                                        <input class="form-control" name="licence_number" value="{{ $instructor->licence_number }}" required>
                                    </div>
                                    <div class="mb-3 col-4">
                                    ...
                                    <div class="mb-3 col-4">
                                        ...
                                        <input class="form-control" name="defensive_number" value="{{ $instructor->defensive_number }}" required >
                                    </div>
                                    <div class="mb-3 col-4">
                                    ...
                                    <div class="mb-3 col-4">
                                        ...
                                        <input class="form-control" type="text" name="phone"value="{{ $instructor->phone }}" required>
                                    </div>

                                    <div class="mb-3 col-4">
                                        <label class="form-label f-w-500">Branch</label>
                                        <select class="form-control" name="branch_id">
                                            <option value="{{$instructor->branch_id}}">{{$instructor->branch_name}}</option>
                                    ...
                                    <div class="mb-3 col-6">
                                        <textarea name="address" id="" cols="30" rows="4" class="form-control" placeholder="Address" required>{{ $instructor->address }}</textarea>
                                    </div>
                                    <div class="mb-3 col-6 row">
                                        @forelse($courses as $course)
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label col-form-label " for="permission{{$course->id}}"> {{$course->name}}</label>
                                                <input type="checkbox" id="permission{{$course->id}}" @checked(in_array($course->id, $icourses)) name="courses[]" value="{{$course->id}}">
                                            </div>
                                        @empty
                                        @endforelse
                                    </div>
